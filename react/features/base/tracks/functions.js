...
export function createLocalTracksF(
    ...
    const constraints = APP.store.getState()['emg'].roomInfo.largeView == "1" ? largeConstraints: normalConstraints;
    const resolution = APP.store.getState()['emg'].roomInfo.largeView == "1" ? largeResolution: normalResolution;
