...
import { ROLE_TEACHER, ROLE_STUDENT, ROLE_AC } from '../../react/vcrx/base';
                        ...
                        switch (role) {
                            ...
                            case ROLE_TEACHER:
                                if (APP.conference.isLocalAudioMuted()) {
                                    ...
                                    console.log("PushToTalk is available to Teacher and AC !!!");
                                    APP.conference.muteAudio(false);
                                }
            
                                break;
                            case ROLE_STUDENT:
                                console.log("PushToTalk is disabled for student !!!");
                                break;
                 /*   if (APP.conference.isLocalAudioMuted()) {
                        sendAnalytics(createShortcutEvent(
                            'push.to.talk',
                            PRESSED));
                        logger.log('Talk shortcut pressed');
                        console.log("PushToTalk is disabled!!!");
                        //APP.conference.muteAudio(false);
                    }*/
                        }
                    }
