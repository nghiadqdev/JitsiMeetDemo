...
class Pdf extends React.Component {
  ...
  componentDidMount() {
    ...
    window.addEventListener('resize',() =>{
      ...
      this.state.pdf.getPage(this.props.page).then(this.onPageComplete);
    });
  ...
  componentWillReceiveProps(newProps) {
    ...
    if(newProps.tileViewEnabled != this.props.tileViewEnabled || newProps.fullScreen != this.props.fullScreen){
      this.setState({ page: null });
  ...
  render() {
    ...
    return page ?
      ...
      :
      loading || <div style={{color :"#000",fontSize : "3vh"}}>Loading Slide...</div>;
  }
}
