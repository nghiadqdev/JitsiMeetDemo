...
import { Room } from '/vcrx/conference';
import { 
    Header, Slide, Timer,
} from '/vcrx/conference/components';
// import CameraParticipant from '/vcrx/conference/components/camera-participant/CameraParticipant';
import { changeUserInfo } from '/vcrx/actions';
import { LARGE_VIEW_MODE } from '/vcrx/base';
...
class Conference extends AbstractConference<Props, *> {
     ...
     */
    render() {
        const { _showChat, _showSlide, _largeView, _role, _isolated, _swapCam } = this.props;
        const { width, height } = this.state;
            return (
                // _largeView == 1 && LARGE_VIEW_MODE.includes(_role) ?
                // (
                //     <div
                ...
                //                 <div>
                //                     {_swapCam ?
                //                     <CameraParticipant isTeacherCamera = {true} />
                //                     : <Slide boxW ={width} boxH = {height}/>}
                //                 </div>
                //             </Resizable>
                //         </div>
                //         {
                ...
                //         <div id = 'videospace' className = {`${_swapCam && 'hiddenElement'}`}>
                //             <LargeVideo /> 
                //         </div>
                //         <div id = 'largeFilmstrip'>
                //             <Timer/>
                //             <Filmstrip hiddenClass = {_isolated == 1 ? 'hiddenElement' : ''} />
                //         </div>
