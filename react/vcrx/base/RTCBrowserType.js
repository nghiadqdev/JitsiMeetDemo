...
const RTCBrowserType = {
    ...
    RTC_BROWSER_COC_COC: "rtc_browser.coc-coc",
    ...
    /**
     * @author : Tungns4
     * @description : lấy Tên trình duyệt và version của trình duyệt 
     * @returns {string}
     */
    getBrowser(){
        let BrowserName;
        const isAndroid = navigator.userAgent.indexOf("Android") !== -1;
        const isCocCoc  = navigator.vendor.indexOf("Coc Coc") !== -1;
        ...
        if (isCocCoc) {
            return "Brower is coc-coc, ver:" + browserVersion;
        }

        BrowserName = currentBrowser.split("rtc_browser.")[1];

        return "Brower is "+BrowserName+", ver:" + browserVersion;
    },
