...
function _mapStateToProps(state) {
    ...
    if (showProfileSettings && interfaceConfig.ishowProfileSettings) {
        tabs.push({
    ...
    if (showCalendarSettings && interfaceConfig.isshowCalendarSettings) {
        tabs.push({
    ...
    if ((showModeratorSettings || showLanguageSettings ) && interfaceConfig.isshowLanguageSettings) {
        tabs.push({
